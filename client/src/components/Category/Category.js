                                ...
                                <Box sx={{ width: 120 }}>
                                    <FormControl fullWidth size="small">
                                        ...
                                        >
                                            ...
                                            <MenuItem value={'New Fashion'}>New Fashion</MenuItem>
z                                           <MenuItem value={'Best Selling'}>Best Selling</MenuItem>
                ...
                <div className="category__card__container">
                    <div className="category__product__card">
                        {props.items.map((data) => (
                            <ItemCard key={data._id || data.id} item={data} category={props.category} />
                        ))}
